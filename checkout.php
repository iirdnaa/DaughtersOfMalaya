...
<link rel="stylesheet" href="style.css"> 
      ...
      ?>
                <li><a class="active" href="cart.php"><i class='bx bxs-cart'></i><span><?php echo $row_count; ?></span></a></li>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="Kuala Lumpur" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="Wilayah Persekutuan" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="Malaysia" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
